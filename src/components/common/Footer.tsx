  ...
  return (
    <>
      ...
      <div className="mb-6 w-full">
        <div className="font-NotoSansKR relative mx-5 flex h-[104.5px] items-center justify-start whitespace-pre text-wrap text-12 font-medium leading-[21px] text-gray_400">
