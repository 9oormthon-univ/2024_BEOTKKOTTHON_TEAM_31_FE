...
const LogoutPage = () => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-start overflow-hidden">
      <div className="rounded-b-12 flex w-full flex-col items-center justify-start bg-main px-[30px] pb-[50px] pt-[24px]">
        <div className="mt-[24px] flex w-full items-center justify-center px-[38px]">
          <Logo className="h-auto w-full" />
        </div>
        <div className="text-18 mt-[24px] font-semibold text-white">과자처럼 언제 어디서나 간편하게!!</div>
        <div className="text-14 mt-[20px] w-full whitespace-pre text-wrap text-center font-normal text-white sm:text-12">
      ...
      <div className="flex w-full -translate-y-[25px] flex-col gap-y-4 px-4">
        <input
          className="rounded-8 w-full border border-sub_100 bg-white px-4 py-4 text-center text-16 font-bold outline-none transition-all duration-200 ease-in-out placeholder:text-gray-300 focus:border-sub_200"
